  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      ...
      <div className="bg-white w-full max-w-4xl rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        {/* Left Side: Image/Branding (Mobile par upar, Desktop par left) */}
        ...
        <div className="md:w-1/2 p-8 md:p-12">
          ...
          <form className="space-y-5">
            ...
            {/* Login Button */}
            <button className="w-full bg-teal-600 text-white py-3 rounded-lg font-bold hover:bg-teal-700 transition-colors flex items-center justify-center gap-2">
              Sign In
              <ArrowRight size={18} />
            </button>
          </form>
          ...
          {/* Google Button (Fake for UI) */}
          <button className="w-full border border-gray-300 bg-white text-slate-700 py-2.5 rounded-lg font-medium hover:bg-gray-50 transition-colors flex items-center justify-center gap-2">
